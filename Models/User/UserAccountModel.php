...
/* ▂ ▅ Methodes ▅ ▂ */
    ...
    /* ▂ ▅  findJointById( int $id )  ▅ ▂ */
        public function findJointById( $id ) { 
    ...
    public function createJoint( Useraccount $Useraccount ) { 
        ...
        $this -> request -> bindValue(":identifiant", $Useraccount -> getIdentifiant(), PDO::PARAM_STR);
        $this -> request -> bindValue(":password", $Useraccount -> getPassword(), PDO::PARAM_STR);
